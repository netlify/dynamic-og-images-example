...
export default async (request: Request, context: Context) => {
  ...
  const boldFontFileResponse = await fetch(
    new URL(origin + "/fonts/pacaembu/PacaembuNetlify-Bold.woff")
  );
  const mediumFontFileResponse = await fetch(
    new URL(origin + "/fonts/pacaembu/PacaembuNetlify-Medium.woff")
  );
...
export const config: Config = {
  path: "/__TODO__/:collectionType/:slug",
};
